...
namespace proyControlInv
{
    public partial class Form1 : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            int minutos = Convert.ToInt32(txtCantidad.Text);
        ...
        {
            string nombre = txtNombre.Text;
            int horaInicio = Convert.ToInt32(txtHoraInicio.Text);
            int horaFin = Convert.ToInt32(txtHoraFin.Text);

            txtReporte.Text = ruta.recorrido(nombre, horaInicio, horaFin);
        }
    }
}
